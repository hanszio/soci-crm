...
export const PROVIDER_INFO: Record<AiProvider, ProviderInfo> = {
  ...
  opencode: {
    ...
    models: [
      ...
      { id: "mimo-v2.5-free", label: "MiMo V2.5", tag: "gratis", judge: true },
  ...
  "opencode-go": {
    ...
    models: [
      { id: "deepseek-v4-flash", label: "DeepSeek V4 Flash", tag: "recomendado", judge: true, note: "Rápido, buen español y cuota alta (~7,600 peticiones / 5 h)." },
      { id: "gpt-5.6-luna", label: "GPT 5.6 Luna", tag: "recomendado", judge: true, note: "El más pulido del plan para conversación; ~2,000 peticiones / 5 h." },
      { id: "qwen3.8-flash", label: "Qwen 3.8 Flash", tag: "economico", judge: true, note: "Cuota muy alta (~5,400 / 5 h)." },
      { id: "glm-5.3-flash", label: "GLM 5.3 Flash", tag: "economico", judge: true, note: "Cuota muy alta (~1,500 / 5 h)." },
      ...
      { id: "qwen3.8-max", label: "Qwen 3.8 Max", tag: "calidad" },
      { id: "deepseek-v4-pro", label: "DeepSeek V4 Pro", tag: "calidad" },
      { id: "kimi-k3", label: "Kimi K3", note: "Cuota baja (~110 / 5 h)." },
      { id: "glm-5.3", label: "GLM 5.3" },
      { id: "grok-4.6", label: "Grok 4.6" },
      { id: "minimax-m3", label: "MiniMax M3" },
    ],
    hint: "Plan de US$10/mes con 30+ modelos abiertos y límites por valor (US$12 cada 5 h, US$30 por semana, US$60 al mes). No incluye Claude ni GPT-5.5: para esos usa OpenCode Zen con saldo.",
  },
  openrouter: {
    id: "openrouter",
